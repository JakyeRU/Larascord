...
```php copy=false
/**
* Returns a guild within the user's guilds from Discord's API.
*
* @return Illuminate\Support\Collection
...
try {
    $guildMember = $user->getGuild('123456789012345678');
...
<Callout type="info">
    The bot must belong to the same application used for authorization and must be a member of the guild.
</Callout>
```php copy=false
/**
* Returns all channels within a specified guild from Discord's API.
*
* @return Illuminate\Support\Collection
* @throws RequestException
*/
...
try {
    $guildChannels = $user->getGuildChannels('123456789012345678');

    Log::info(json_encode($guildChannels));
    /*
        {
          "id": "123456789012345678",
          "type": 4,
...
```php copy=false
/**
* Returns all roles within a specified guild from Discord's API.
*
* @return Illuminate\Support\Collection
* @throws RequestException
*/
...
try {
    $guildRoles = $user->getGuildRoles('123456789012345678');

    Log::info(json_encode($guildRoles));
    /*
        {
            "id": "123456789012345678",
            "name": "@everyone",
...
```php copy=false
/**
* Returns the guilds preview from Discord's API.
*
* @return Jakyeru\Larascord\Types\GuildPreview|null
* @throws Illuminate\Http\Client\RequestException
* @throws RequestException
*/
```
...
try {
    ...
    /*
        {
            "id": "1151478836840648756",
            "name": "Rockford Haulage",
            "icon": null,
            "splash": null,
